...
describe Post do
  ...
  describe ".find_by_permalink" do
    subject { Post.find_by_permalink("2012", "09", "17", slug) }

    context "when slug has invalid encoding" do
      let(:slug) { %q{ setting-up-a-rails-3-2-project-to-use-rspec-and-factory-girl-in-the-generator+Result:+\xED\xE5+\xED\xE0\xF8\xEB\xEE\xF1\xFC+\xF4\xEE\xF0\xEC\xFB+\xE4\xEB\xFF+\xEE\xF2\ } }
  ...
  describe '#denormalize_comments_count!' do
